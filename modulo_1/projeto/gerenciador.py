...
def atualizar_nome_tarefa(tarefas, indice_tarefa, novo_name_tarefa):
  indice_tarefa_ajustado = int(indice_tarefa) - 1
  if indice_tarefa_ajustado >= 0 and indice_tarefa_ajustado < len(tarefas):
    tarefas[indice_tarefa_ajustado]["tarefa"] = novo_name_tarefa
    print(f"Tarefa {indice_tarefa} atualizada para {novo_name_tarefa}")
  else:
